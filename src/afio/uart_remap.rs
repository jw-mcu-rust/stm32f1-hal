...
macro_rules! impl_remap_mode_for {
    ($mode_peri:ty, $operation:expr) => {
        impl RemapMode for $mode_peri {
...
impl_remap_mode_for!(RemapDefault<USART1>, |_, w| w.usart1_remap().clear_bit());
impl_remap_mode_for!(RemapFull<USART1>, |_, w| w.usart1_remap().set_bit());
impl_remap_mode_for!(RemapDefault<USART2>, |_, w| w.usart2_remap().clear_bit());
impl_remap_mode_for!(RemapFull<USART2>, |_, w| w.usart2_remap().set_bit());
impl_remap_mode_for!(RemapDefault<USART3>, unsafe {
    |_, w| w.usart3_remap().bits(0b00)
});
impl_remap_mode_for!(RemapPart1<USART3>, unsafe {
    |_, w| w.usart3_remap().bits(0b01)
});
impl_remap_mode_for!(RemapFull<USART3>, unsafe {
    |_, w| w.usart3_remap().bits(0b11)
});

// table
// Do NOT manually modify the code.
// It's generated by scripts/generate_remap_table.py from scripts/table/stm32f1_remap_device.csv
